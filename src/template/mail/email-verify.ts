export default (app_url, user, config) => {
  return `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    ...
    <table cellpadding="0" cellspacing="0" border="0" style="border-bottom:3px solid #0a579b!important;padding:13px 0px 3px;width:630px;    margin: auto;">
        <tbody><tr>
            <td valign="middle">
                <a href="/" title="" target="_blank" data-saferedirecturl="https://www.google.com/url?q=https://www.craftivestudio.com/&amp;source=gmail&amp;ust=1622122055947000&amp;usg=AFQjCNFMSDftH1FzzAL4oCeTlqCjtgF4yQ">
                <img src="https://www.vtlnews.com/wp-content/uploads/2021/07/VTL-News-021.png" alt="vtl news logo"  class="CToWUd"></a>
            </td>
            <td valign="top" style="text-align:right">
                <table width="100%" cellpadding="1" cellspacing="0" style="text-align:right">
                    ...
                    <tr>
                        <td>
                            <a style="background:#0a579b!important;width:230px;padding:5px 12px 5px;margin-top:4px;font-size:14px;display:inline-block;text-decoration:none" href="tel:${config.PHONE_NUMBER.trim()}" target="_blank"><img src="https://ci5.googleusercontent.com/proxy/ESqEs3v7oBaTA1AvRtWcutKPbFIbv5QqTpi6rm3vbQoGkSR90mAl5NTpAUaHUfYgFvgiAj6PweGmXDlFUo7HdIUVJQE8KsqLRgA-t6ng=s0-d-e1-ft#https://www.craftivestudio.com/assets/images/icon_phone.png" width="11" height="13" class="CToWUd"><span style="color:#fff;margin-left:8px;font-weight:700">
                                ${config.PHONE_NUMBER}&nbsp;&nbsp;&nbsp;
                            </span></a>
                        </td>
                    </tr>
    ...
    <table style="margin:0px;padding:0px;font-size:12px;color:#000;font-family:Arial;line-height:20px;width:630px;margin: auto;">
        <tbody><tr>
            <td>
                ...
                <p>We received a request to reset the password on your ${
                  config.APP_NAME
                } Account.</p>
                <p style="font-size:20px"><a href="${app_url}/verify-account?token=${
    user.otp.iv
